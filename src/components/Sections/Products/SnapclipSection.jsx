        ...
        <div className="w-full flex justify-center flex-col px-3 lg:px-0">
          <div>
            ...
            <p className="lg:max-w-[60%]">
              Envía y guarda fragmentos y resúmenes de videos alojados en
              plataformas como YouTube, Twitch, Vimeo o DailyMotion. Una
              herramienta esencial para tu día a día como estudiante o como
              usuario casual.
            </p>
            <div className="flex flex-row justify-center lg:justify-start mt-7 space-x-5">
              <Button
                href="https://snapclip.tv"
                target="_blank"
                rel="noreferrer"
              >
                Visitar
      ...
      <div className="relative w-full flex flex-1 mt-10 z-10 mb-20 bg-neutral-200 dark:bg-neutral-900">
        <div className="relative w-full flex justify-center items-end space-x-7 py-10">
          <div className="flex flex-col justify-center items-center">
            <span className="flex text-5xl font-bold dark:text-white mb-5">
              1
            </span>
            <ImageZoom>
              <Image
                placeholder="empty"
                src="/img/snapclip-step-1.png"
                height={694}
                width={342}
