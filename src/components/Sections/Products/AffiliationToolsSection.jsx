      ...
      <div className="container flex flex-col mx-auto lg:px-16 mt-24 lg:mt-0 justify-start">
        <div className="lg:space-x-5 flex">
          <div className="w-full flex justify-center flex-col px-3 lg:px-0">
            ...
            <div>
              <Image className="rounded-2xl dark:bg-[#f1f161]" src="/img/icon-affiliation-tools.svg" width={96} height={96} alt="Affiliation Tools" />
              <h3 className="font-bold text-3xl lg:text-4xl">Affiliation Tools</h3>
              <p className="lg:max-w-[60%]">Genera enlaces de afiliados con la mayoría de programas de afiliados como Amazon, Aliexpress, Etsy, Decathlon, etc... Mientras estás navegando ¡Es gratis! y te ayudará a generar ingresos más fácilmente, como si tuvieras SiteStripe de Amazon pero para todas las tiendas que quieras.</p>
