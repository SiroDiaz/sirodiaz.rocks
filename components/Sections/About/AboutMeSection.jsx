          ...
          <div className="w-full flex justify-center flex-col lg:px-0">
            ...
            <div className="flex flex-col mt-5 lg:flex-row lg:ml-10 space-x-5 mb-36">
              <div className="flex flex-1 max-h-[640px] w-full max-w-[640px] mx-auto mb-5">
                <div className="block">
                  <Image placeholder="empty" src="/img/profile-2.jpg" width={640} height={640} alt="imagen de perfil" />
                </div>
              </div>
              <div className="flex flex-1 px-3">
                ...
                <br /><br />
                Si quieres saber mi stack tecnológico personal, con el que trabajo o he trabajado anteriormente, puedes echar un vistazo a mi <ExternalLink target="_blank" href="https://stackshare.io/SiroDiaz/my-stack" rel="noreferrer">perfil de StackShare</ExternalLink>.
                </p>
              </div>
            </div>
